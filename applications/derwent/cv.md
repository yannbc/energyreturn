...
- Founded and scaled Billcap, building the data platform architecture and ML capability that turned high-volume smart meter data into production decisioning systems across 250,000+ users and 5 energy retailers operating under AER regulation.
- Hired as CPTO at Pendula, where I led engineering, product and AI through the transition from rules-based automation to agentic workflows in production -- shipping ML-driven decisioning for enterprise financial services clients including Allianz. Led AI strategy through acquisition by Smart Communications.
- Designed and shipped production ML systems across regulated industries -- demand forecasting, behavioural segmentation, churn prediction, conversational AI, and agentic customer communication workflows.
- Co-authored peer-reviewed research on energy demand elasticity and behavioural interventions with the University of Melbourne, published in the Journal of Political Economy and the Review of Economics and Statistics.
- Deep experience in data governance, privacy, and compliance in regulated environments -- energy (AER-regulated) and financial services.
...
Data Platform Architecture | AI and Data Science | Machine Learning | Regulated Industries | Data Governance | Customer Engagement | Energy and Financial Services
...
- Shipped agentic customer communication workflows in production, orchestrating real conversations with ML-driven decisioning for enterprise clients in financial services, energy, and insurance.
...
- Established responsible AI practices including model monitoring, bias detection, and governance documentation for customer-facing AI systems.
...
- Co-founded and led company delivering a data and ML platform to energy retailers and distributors, operating in AER-regulated environments with strict data governance and privacy requirements. Built the data platform architecture and data science capability from the ground up.
- Designed and built data ingestion and processing pipelines for high-volume smart meter data (30-minute interval reads across 250,000+ users), handling data quality, imputation, and regulatory reporting requirements.
